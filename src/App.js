...
import ComissioGenereGrupTreball from "./pages/ComissioGenereGrupTreball";
		...
		<Router>
			...
			<main className="page">
				<Routes>
					...
					<Route path="/comissio-genere-grup-treball" element={<ComissioGenereGrupTreball />} />
					<Route path="/comissio-genere-grup-treball/:any" element={<ComissioGenereGrupTreball />} />
