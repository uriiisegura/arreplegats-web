	...
	render() {
		return (<>
			...
			<section className="historia">
				...
				<p>
					En reprendre l'activitat castellera després del confinament, hi havia molta feina a fer. Renovació, formació, recaptació de nous castellers, etc. Va ser un procès llarg però no per això el vam encarar amb menys il·lusió.
				</p>
				<p>
